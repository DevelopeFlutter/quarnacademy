    ...
    <div className="bg-gray-900 pt-4 sm:py-12 text-white" id="contact">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-10 flex justify-center items-center gap-10">
          <a to="https://www.instagram.com/adreesGujjar" target="_blank" rel="noopener noreferrer" className="flex justify-center items-center">
            <img
          ...
          <a to="https://www.linkedin.com/in/muhammad-adrees-833210241/" target="_blank" rel="noopener noreferrer" className="flex justify-center items-center">
            <img
              className="max-h-12 w-full object-contain transition-transform duration-300 hover:scale-110"
          ...
          <a to="https://github.com/M-Adrees-gujjar" target="_blank" rel="noopener noreferrer" className="flex justify-center items-center">
            <img
              className="max-h-12 w-full object-contain transition-transform duration-300 hover:scale-110"
              src="https://res.cloudinary.com/dkzca4hyd/image/upload/v1719996547/FaceBook_m2qm75.png"
              alt="GitHub"
              width={158}
              height={48}
            />
      ...
      <div className="space-y-2">
        ...
        <img
            ...
            className="h-7 w-7"
            alt=""  />
          <p>Mufti Muhammad Zafrullah Bilal</p>
        </div>
        <div className="flex items-center space-x-2">
        <img
        ...
        <div className="flex items-center space-x-2">
            ...
            className="h-6 w-8"
            alt=""  />
          <p>zafrullahbilal51@gmail.com</p>
        </div>
      </div>
    </div>
    </div>
